...
export function GitHubLink() {
  ...
  return (
    <a
      ...
      className="flex h-11 items-center justify-center gap-1.5 border-2 border-edge bg-white/5 px-3 text-ink transition-all hover:bg-white/10 pointer-events-auto md:h-9"
    >
      <Github size={15} />
      {stars !== null && (
